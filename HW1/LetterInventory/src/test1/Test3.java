package test1;// This program tests stage 3 of the test1.LetterInventory class.  The program reads
...
public class Test3 {
    public static void main(String[] args) {
        Scanner input = null;
        try {
            input = new Scanner(new File("LetterInventory/src/test1/test3.txt"));
        ...
        while (input.hasNext()) {
            ...
            try {
                ...
                System.out.println("    in test1.LetterInventory line#" + line);
                System.exit(1);
            }
