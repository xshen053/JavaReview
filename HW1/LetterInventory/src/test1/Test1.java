package test1;// This program tests stage 1 of the test1.LetterInventory class.  The program reads
...
public class Test1 {
    public static void main(String[] args) {
        Scanner input = null;
        try {
            input = new Scanner(new File("LetterInventory/src/test1/test1.txt"));
